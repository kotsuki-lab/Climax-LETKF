...
#INLINE="-Minline"
F90OPT='-convert big_endian -assume byterecl -O3 -mcmodel=large -heap-arrays -xHost' # -pg'
#F90OPT='-convert big_endian -assume byterecl -O3 -mcmodel=large -heap-arrays -xHost -check bounds' # -pg'
